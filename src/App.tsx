      ...
      <footer className="bg-earth-100 py-20 border-t border-earth-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-12 mb-16">
              ...
              <p className="text-olive-800/60 max-w-sm leading-relaxed">
                ...
                <span className="text-[10px] font-bold uppercase tracking-widest mt-4 block">
                  ...
                  <a
                    ...
                    className="hover:text-olive-600 transition-colors underline underline-offset-2"
                  >
                    Youssef Benamor
                  </a>
                </span>
            ...
            <div>
              <h5 className="text-xs font-bold uppercase tracking-widest text-olive-400 mb-6">
                Explore
              </h5>
                ...
                <li>
                  <button
                    onClick={() => {
                      ...
                      setChatInput(
                        lang === "tn"
                          ? "كيفاش نجم نتواصل مع خبراء فلاحين؟"
                          : lang === "fr"
                            ? "Comment puis-je contacter des experts agricoles ?"
                ...
                <li>
                  <button
                    onClick={() => {
                      ...
                      setChatInput(
                        lang === "tn"
                          ? "وريني قصص نجاح فلاحية في تونس."
                          : lang === "fr"
                            ? "Montre-moi des réussites agricoles en Tunisie."
                            : "Show me some agricultural success stories in Tunisia.",
                      );
                    }}
                    className="hover:text-olive-900 transition-colors cursor-pointer text-left"
                  >
