...
export const TRANSLATIONS = {
  en: {
    ...
    quotaExceededDesc: "The free AI quota has been reached for today. To continue using the expert, please select your own API key.",
    selectApiKey: "Select API Key",
    apiKeySelected: "API Key Selected! You can now continue chatting.",
    footerAbout: "Empowering the next generation of Tunisian farmers with data-driven insights and sustainable practices.",
    footerExplore: "Explore",
    footerLocations: "Our Locations",
    footerContact: "Contact Us",
    footerDevelopedBy: "Owned & Developed by",
    footerDevName: "Youssef Benamor Dev",
    locationSomaa: "Great Farming Somaa",
    locationBoujrida: "Great Farming Boujrida"
  },
  fr: {
    ...
    quotaExceededDesc: "Le quota IA gratuit a été atteint pour aujourd'hui. Pour continuer à utiliser l'expert, veuillez sélectionner votre propre clé API.",
    selectApiKey: "Sélectionner Clé API",
    apiKeySelected: "Clé API Sélectionnée ! Vous pouvez maintenant continuer à discuter.",
    footerAbout: "Autonomiser la prochaine génération d'agriculteurs tunisiens avec des informations basées sur les données et des pratiques durables.",
    footerExplore: "Explorer",
    footerLocations: "Nos Emplacements",
    footerContact: "Contactez-nous",
    footerDevelopedBy: "Propriété & Développé par",
    footerDevName: "Youssef Benamor Dev",
    locationSomaa: "Great Farming Somaa",
    locationBoujrida: "Great Farming Boujrida"
  },
  tn: {
    ...
    quotaExceeded: "وفات الحصة (Quota)",
    quotaExceededDesc: "الحصة المجانية للذكاء الاصطناعي وفات لليوم. باش تكمل تسأل الخبير، لازمك تختار مفتاح API خاص بيك.",
    selectApiKey: "اختار مفتاح API",
    apiKeySelected: "تم اختيار المفتاح! توة تنجم تكمل تسأل.",
    footerAbout: "تمكين الجيل القادم من الفلاحين التوانسة بالمعلومات والذكاء الاصطناعي.",
    footerExplore: "اكتشف",
    footerLocations: "مواقعنا",
    footerContact: "اتصل بنا",
    footerDevelopedBy: "ملك و تطوير",
    footerDevName: "Youssef Benamor Dev",
    locationSomaa: "Great Farming Somaa",
    locationBoujrida: "Great Farming Boujrida"
  }
